---
title: "Configuring Firewall SCA"
sidebarTitle: 'Configuration'
description: "This guide will walk you through the process of setting up Firewall SCA for your version control system and enabling real-time scanning capabilities."
---
...
* Access to Firewall SCA platform

## Step 1: Configuring Your Version Control Token

1. Navigate to the **Settings** page in Firewall SCA `https://<app-url>/settings?tab=configuration`
...
* Connected your version control system to Firewall SCA

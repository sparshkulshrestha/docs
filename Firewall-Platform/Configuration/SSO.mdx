---
title: "SSO"
description: "This guide provides a step-by-step walkthrough of configuring Single Sign-On (SSO) for Firewall Secrets. SSO allows users to authenticate with their existing identity provider (IdP) credentials, simplifying access and improving security. "
---

<iframe width="560" height="315" src="https://www.youtube.com/embed/LP4sEYOuEv4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen />
...
1. **Navigate to the SSO Settings Page:**
   ...
   * Open your web browser and go to the Firewall Secrets application: `https://<app-url>/settings?tab=sso`

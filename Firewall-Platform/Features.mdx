...
[Read more about our scoring engine here](https://blogs.thefirewall.org/taming-the-alert-tsunami-dynamic-scoring-and-risk-based-prioritisation-in-cybersecurity)